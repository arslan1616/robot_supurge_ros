...
```bash
cd ~/catkin_ws/src
git clone https://github.com/arslan1616/robot_supurge_ros.git
...
Projenin başarıyla çalıştığını, robotun odalar arası geçişini ve hata durumlarında (sıkışma, QR bulamama) nasıl tepki verdiğini gösteren demo videosuna aşağıdaki bağlantıdan ulaşabilirsiniz:

**Video Linki:** [BURAYA YOUTUBE LİNKİNİ EKLEYİNİZ]
